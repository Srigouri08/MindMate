(() => {
  ...
  const css = `
    ...
    body[data-mm-theme="dark"] .mm-photo-panel { background:#29243a!important;color:#eee7fa!important;border-color:#514668!important;box-shadow:0 22px 55px rgba(0,0,0,.45)!important; }
    ...
    body[data-mm-theme="dark"] .mm-photo-panel input { background:#211d2e!important;color:#eee7fa!important;border-color:#554a69!important; }
    ...
    body[data-mm-theme="dark"] .mm-toolbar[data-mm-final].mm-scoped-toolbar { background:rgba(35,30,48,.98)!important;border-color:#514668!important;box-shadow:0 12px 30px rgba(0,0,0,.42)!important; }
    body[data-mm-theme="dark"] .mm-toolbar[data-mm-final] .mm-tool,
    body[data-mm-theme="dark"] .mm-toolbar[data-mm-final].mm-scoped-toolbar .mm-tool { background:#302943!important;border-color:#514668!important;color:#eee7fa!important; }
    ...
    .mm-final-panel .mm-template-grid button { min-height:86px!important;height:86px!important;padding:13px 14px!important;display:flex!important;flex-direction:column!important;justify-content:center!important;align-items:flex-start!important;gap:5px!important;text-align:left!important;line-height:1.15!important;overflow:hidden!important; }
    ...
    .mm-final-panel .mm-template-grid button[data-t="default"] ~ button[data-t="default"] { display:none!important; }
    ...
    @media(max-width:600px){ .mm-final-panel .mm-template-grid{grid-template-columns:1fr!important}.mm-final-panel .mm-template-grid button{height:78px!important;min-height:78px!important}.mm-final-panel .mm-template-grid .mm-reset-final-template{height:56px!important;min-height:56px!important} }
  `;
  ...
  function removeDuplicateTemplateDefaults() {
    document.querySelectorAll(".mm-final-panel .mm-template-grid").forEach((grid) => {
      let found = false;
      [...grid.querySelectorAll("button")].forEach((button) => {
        const text = (button.textContent || "").trim();
        const isDefault = button.dataset.t === "default" || /Set to Default/i.test(text);
        if (!isDefault) return;
  ...
  function setPromptWatermark() {
    ...
    if (!textarea) return;
    const isNew = [...document.querySelectorAll(".sidebar .side-item")].some((button) => /New Entry/i.test(button.textContent || "") && button.classList.contains("active"));
    if (!isNew) { textarea.removeAttribute("data-mm-prompt-watermark"); return; }
    ...
    } else textarea.removeAttribute("data-mm-prompt-watermark");
  }
  ...
  function cleanTemplatePanel() {
    ...
    removeDuplicateTemplateDefaults();
  }
